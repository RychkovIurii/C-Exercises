...
/*
This requires a file by the name of "my_first_file.txt" to exist in the same directory as
the code
...
Then change the code slightly to read from "my_second_file.txt" which contains doubles
